...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        for detection in admissibleDetections:
            ...
            if (int(detection.spatialCoordinates.z) < MaxDistanceThreshold) and (int(detection.spatialCoordinates.z)>MinDistanceThreshold) :
                LedOnFunc()
                # code to print the object detected and its depth
        ...
        # code to show computer vision and depth map windows 
